...
//If so run program
//-----------------------------------------------------------------------------------------------
$res = "<div id=\"chat\" class=\"chat_box_wrapper chat_box_small chat_box_active\" style=\"opacity: 1; display: block; transform: translateX(0px);\"><div class=\"chat_box touchscroll chat_box_colors_a\">";
		...
		else
		{
			...
			if($response_Array['who'] == "human")
			{
				...
				for($i=$convoLines;$i>=0;$i--)
				{
					...
					{
						$res .= "<div class=\"chat_message_wrapper chat_message_right\"><div class=\"chat_user_avatar\"> <font color=\"White\">You</font></div><ul class=\"chat_message\"><li><p>".stripslashes(urldecode($response_Array['input'][$i]))."</p></li></ul></div>"; // input of the user
   						$res .= "<div class=\"chat_message_wrapper\"><div class=\"chat_user_avatar\"> <font color=\"White\">Jarvis</font></div><ul class=\"chat_message\"><li><p>".stripslashes(urldecode($response_Array['that'][$i]))."</p></li></ul></div>"; // response of jarvis
					}
					else
					{
						$res .= "<div class=\"chat_message_wrapper chat_message_right\">&nbsp;</div>";
						$res .= "<div class=\"chat_message_wrapper\">&nbsp;</div>";
					}
				}
